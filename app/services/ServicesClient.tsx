...
import {
  FaCogs, FaRocket, FaMobileAlt, FaCode, FaCloud, FaChartLine, FaArrowRight,
  FaHandshake, FaLightbulb, FaBolt, FaGlobeAfrica,
} from "react-icons/fa";
...
const WHY_US = [
  ...
  },
  {
    ...
    desc: "We understand African markets and build for global scale.",
  },
];

export default function ServicesClient() {
  // Gate rendering to the client (avoid running RTK Query during build/SSR)
