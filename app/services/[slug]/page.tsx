  ...
  if (!service) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center">
        ...
        <Link href="/services" className="px-6 py-2 rounded bg-blue-600 hover:bg-blue-800 text-white font-bold shadow">
          <FaArrowLeft className="inline mr-2" /> Back to Services
        </Link>
      </div>
    );
  }
