...
const SSO_PROVIDERS = [
  {
    ...
    onClick: () => {
      // Safe on client; this file is a Client Component
      window.location.href = `${baseAPI}/accounts/google/login/`;
    },
  },
];

export default function SignupScreenClient() {
  ...
  useEffect(() => {
    // client-only storage guard
    if (typeof window !== "undefined" && !sessionStorage.getItem("store_reset")) {
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-3 w-full">
          ...
          <button
            ...
            className={`w-full py-3 rounded-xl text-base font-extrabold shadow-xl transition-all ${
              loading ? "bg-blue-300 text-blue-100 cursor-not-allowed" : "bg-blue-700 hover:bg-blue-900 text-white"
            }`}
            disabled={loading}
          >
