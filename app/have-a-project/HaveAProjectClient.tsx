...
export default function HaveAProjectClient() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-blue-950 via-blue-900 to-gray-950 flex flex-col items-center justify-center px-2 sm:px-4">
      ...
      >
        <div className="bg-white/90 rounded-2xl shadow-xl p-6 sm:p-8 flex flex-col items-center mb-8">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-3 mt-3 w-full">
            <a
              href="https://wa.me/27659031894"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 px-4 py-2 rounded-full bg-green-500 hover:bg-green-600 text-white font-semibold shadow transition justify-center"
            ...
            <a
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-full bg-blue-500 hover:bg-blue-700 text-white font-semibold shadow transition justify-center"
              aria-label="Email us"
            >
              <FaEnvelope /> Email Us
            </a>
            <a
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-full bg-gray-800 hover:bg-blue-900 text-white font-semibold shadow transition justify-center"
              aria-label="Call us"
            >
        ...
        <AnimatePresence mode="wait">
          {submitted ? (
            ...
            >
              ...
              <button
                type="submit"
                className="flex items-center gap-2 justify-center mt-2 w-full py-3 rounded-xl bg-blue-600 hover:bg-blue-800 text-white font-bold text-lg shadow transition-all disabled:opacity-50"
                disabled={loading}
              >
                {loading ? <span className="animate-spin mr-2">⏳</span> : <FaArrowRight />}
      ...
      >
        <h3 className="text-lg sm:text-xl font-bold text-blue-100 mb-6 uppercase tracking-wider">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-7">
          <div className="bg-white/90 rounded-lg shadow-lg p-5">
            ...
            <div className="text-gray-700 text-sm">
              We measure our success by your growth—ROI, leads, and engagement.
            </div>
          </div>
          <div className="bg-white/90 rounded-lg shadow-lg p-5">
            <div className="text-4xl text-blue-400 mb-2">🤝</div>
            ...
            <div className="text-gray-700 text-sm">
              You get dedicated experts, transparent progress, and true collaboration.
            </div>
          </div>
          <div className="bg-white/90 rounded-lg shadow-lg p-5">
            <div className="text-4xl text-blue-400 mb-2">💡</div>
            ...
            <div className="text-gray-700 text-sm">
              Web, mobile, automation, design & marketing—all under one roof.
            </div>
          </div>
        </div>
      </motion.section>
