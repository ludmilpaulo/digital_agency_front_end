  ...
  return (
    <main className="max-w-3xl mx-auto px-6 py-20">
      ...
      <section className="mb-10">
        ...
        <p>
          Maindo Digital Agency (“we”, “us”, or “our”) is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website or use our services.
        </p>
      </section>
      ...
      <section className="mb-10">
        ...
        <ul className="list-disc pl-6">
          <li><strong>Personal Information:</strong> Name, email address, phone number, company, etc.</li>
      ...
      <section className="mb-10">
        ...
        <ul className="list-disc pl-6">
          ...
          <li>To send you updates, newsletters, or marketing communications (you can unsubscribe at any time).</li>
      ...
      <section className="mb-10">
        ...
        <ul className="list-disc pl-6">
          <li>We do <span className="font-semibold text-green-700">not</span> sell or rent your personal information to third parties.</li>
      ...
      <section className="mb-10">
        ...
        <p>
          We use industry-standard measures to protect your information. However, no electronic transmission or storage is 100% secure.
        </p>
      </section>
      ...
      <section className="mb-10">
        ...
        <ul className="list-disc pl-6">
          ...
          <li>Contact us to exercise your rights: <a href="mailto:support@maindodigital.com" className="text-blue-600 underline">support@maindodigital.com</a></li>
        </ul>
      </section>
