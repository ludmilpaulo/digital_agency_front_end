...
const BoardSelector: React.FC<BoardSelectorProps> = ({
  boards, selectedBoardId, setSelectedBoardId, handleDeleteBoard
}) => (
  <div className="flex flex-wrap gap-2">
    {boards.map((b) => (
      <button
        key={b.id}
        className={`px-4 py-2 rounded-xl font-bold shadow ${selectedBoardId === b.id ? "bg-blue-700 text-white" : "bg-blue-200 text-blue-800"} hover:bg-blue-400`}
