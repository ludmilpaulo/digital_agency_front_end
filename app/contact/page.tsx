      ...
      <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-8 mt-6 bg-transparent">
        ...
        <div className="bg-white/90 dark:bg-gray-900/80 backdrop-blur-xl p-8 rounded-3xl shadow-xl border border-blue-100 text-center animate-fade-in-up">
          ...
          <img
            ...
            alt="Agency Logo"
            className="w-20 h-20 rounded-full border-4 border-blue-500 shadow-lg mx-auto mb-3 object-contain"
          />
        ...
        >
          ...
          <button
            type="submit"
            disabled={loading}
            className="mt-6 w-full bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-xl font-bold transition-all shadow-lg"
          >
